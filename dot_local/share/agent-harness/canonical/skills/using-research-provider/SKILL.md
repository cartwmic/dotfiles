...
Copy [standard.json](references/data/configs/standard.json) to a run-specific file, replace the placeholder `artifact_root` with an absolute existing directory, then:
