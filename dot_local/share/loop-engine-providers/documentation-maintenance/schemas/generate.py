...
valid["role-axis-judgment-v1"]={"schema":"role-axis-judgment-v1","run_id":"run-1","manifest_digest":"sha256:"+"0"*64,"bundle_digest":"sha256:"+"1"*64,"judgments":[{"judgment_id":"j1","document":"README.md","clause_id":"R1","verdict":"satisfied","controlling_reason":"role.r1.satisfied","evidence_digests":[],"judge_identity_digest":"sha256:"+"2"*64,"decoding_parameters_digest":"sha256:"+"3"*64}]}
...
schemas["evaluation-recovery-v1"] = record("evaluation-recovery-v1", {"failed_identity":ID,"evaluation_key_digest":DIGEST,"inspected_evidence_digests":arr(DIGEST,128,1),"diagnosed_cause":NONEMPTY_TEXT,"changed_retry_condition":{"oneOf":[NONEMPTY_TEXT,{"type":"null"}]},"transient_failure_rationale":{"oneOf":[NONEMPTY_TEXT,{"type":"null"}]},"caller_retry_authorized":{"const":True}})
schemas["evaluation-recovery-v1"]["oneOf"] = [
    {"properties":{"changed_retry_condition":{"type":"string"},"transient_failure_rationale":{"type":"null"}}},
    {"properties":{"changed_retry_condition":{"type":"null"},"transient_failure_rationale":{"type":"string"}}},
]
...
schemas["breach-remediation-v1"] = record("breach-remediation-v1", {"prior_breach_digest":DIGEST,"binding_rule_semantic_digest":DIGEST,"binding_force":ID,"binding_scope":PATH,"old_manifest_digest":DIGEST,"new_manifest_digest":DIGEST,"changed_non_core_paths":arr(PATH,10000,1),"cited_evidence_digests":arr(DIGEST,128,1),"rule_unweakened":{"const":True},"reassessment_scope":{"const":"whole-repository"},"reassessment_manifest_digest":DIGEST,"reassessment_rule_semantic_digest":DIGEST})
valid["breach-remediation-v1"]={"schema":"breach-remediation-v1","run_id":"run-1","prior_breach_digest":"sha256:"+"0"*64,"binding_rule_semantic_digest":"sha256:"+"1"*64,"binding_force":"binding-invariant","binding_scope":"complete declared repository subsystem","old_manifest_digest":"sha256:"+"2"*64,"new_manifest_digest":"sha256:"+"3"*64,"changed_non_core_paths":["src/lib.rs"],"cited_evidence_digests":["sha256:"+"4"*64],"rule_unweakened":True,"reassessment_scope":"whole-repository","reassessment_manifest_digest":"sha256:"+"3"*64,"reassessment_rule_semantic_digest":"sha256:"+"1"*64}
...
valid["calibration-report-v1"]={"schema":"calibration-report-v1","run_id":"run-1","bundle_digest":"sha256:"+"0"*64,"model_identity_digest":"sha256:"+"1"*64,"decoding_parameters_digest":"sha256:"+"2"*64,"cases":[{"case_id":"case-1","fixture_digest":"sha256:"+"3"*64,"expected_verdict":"adhered","affected_identity":"README.md","controlling_reason":"claim.accurate.supported","observations":[{"ordinal":1,"verdict":"adhered","affected_identity":"README.md","controlling_reason":"claim.accurate.supported"},{"ordinal":2,"verdict":"adhered","affected_identity":"README.md","controlling_reason":"claim.accurate.supported"},{"ordinal":3,"verdict":"adhered","affected_identity":"README.md","controlling_reason":"claim.accurate.supported"}]}],"qualified":True}
