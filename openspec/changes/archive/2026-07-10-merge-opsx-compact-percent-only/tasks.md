...
- [x] 2.1 Update index.ts call sites: threshold computation (~L428–431) and the loop-arm policy notify (~L691) drop the `OPSX_COMPACT_AT_TOKENS` argument; no remaining reference to `OPSX_COMPACT_AT_TOKENS` anywhere in the extension
  - intent: refactor
  - files_allowed:
