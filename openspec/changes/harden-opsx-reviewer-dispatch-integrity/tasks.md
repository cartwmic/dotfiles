...
- [ ] 1.1 code-review check: when `CR_MODE=gating-required`, require own-line
...
- [ ] 1.2 doneness check: same 40-hex + equality binding on doneness.md ONLY
...
- [ ] 2.1 templates/code-review.md: add `**Attested HEAD:**` own-line field +
...
- [ ] 2.2 templates/doneness.md: add `**Attested HEAD:**` field with
      independent-judge (full_rigor) scoping note.
      (opsx-workflow-schema.convergence-template-support)

## 3. Skill prose (dispatch procedure)

- [ ] 3.1 openspec-loop SKILL.md: attestation preamble requirement in every
...
- [ ] 3.2 openspec-apply-change references/opsx-superpowers-mode.md: same
...
- [ ] 4.1 tests/opsx-gate/test_opsx_gate.sh: attestation present+matching →
      ...
      (opsx-gate-enforcement.verdict-freshness-and-provenance)
- [ ] 4.2 tests/opsx-review-convergence/test_review_convergence_surfaces.sh:
