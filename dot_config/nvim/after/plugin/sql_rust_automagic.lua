...
local format_dat_sql = function(bufnr)
  ...
  for id, node in embedded_sql:iter_captures(root, bufnr, 0, -1) do
    ...
    if name == "sql" then
      ...
      local indentation = string.rep(" ", range[2] + 4)
...
vim.api.nvim_create_user_command("RustFormatEmbeddedSql", function()
  format_dat_sql()
end, {})

local group = vim.api.nvim_create_augroup("rust-format-embedded-sql", { clear = true })
